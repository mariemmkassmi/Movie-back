  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="movieApp.category.home.createOrEditLabel" data-cy="CategoryCreateUpdateHeading">
            <Translate contentKey="movieApp.category.home.createOrEditLabel">Create or edit a Category</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('movieApp.category.name')} id="category-name" name="name" data-cy="name" type="text" />
              <ValidatedField
                label={translate('movieApp.category.description')}
