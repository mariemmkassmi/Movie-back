  ...
  return (
    <div>
      <h2 id="category-heading" data-cy="CategoryHeading">
        <Translate contentKey="movieApp.category.home.title">Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="movieApp.category.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/category/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="movieApp.category.home.createLabel">Create new Category</Translate>
          </Link>
        </div>
      </h2>
        ...
        {categoryList && categoryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="movieApp.category.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="movieApp.category.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="movieApp.category.description">Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="movieApp.category.home.notFound">No Categories found</Translate>
            </div>
          )
        )}
      </div>
