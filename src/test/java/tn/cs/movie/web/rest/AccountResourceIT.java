...
import static tn.cs.movie.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import tn.cs.movie.config.Constants;
import tn.cs.movie.domain.User;
import tn.cs.movie.repository.AuthorityRepository;
import tn.cs.movie.repository.UserRepository;
import tn.cs.movie.security.AuthoritiesConstants;
import tn.cs.movie.service.UserService;
import tn.cs.movie.service.dto.AdminUserDTO;
import tn.cs.movie.service.dto.PasswordChangeDTO;
import tn.cs.movie.service.dto.UserDTO;
import tn.cs.movie.web.rest.vm.KeyAndPasswordVM;
import tn.cs.movie.web.rest.vm.ManagedUserVM;
